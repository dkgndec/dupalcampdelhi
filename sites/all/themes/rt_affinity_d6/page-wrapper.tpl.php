			...
			<div class="wrapper">
				<div class="top-bar-padding">
					<div class="topbar-strip">
						...
						<?php if (!$user->uid) : ?>
						<a href="<?php echo base_path(); ?>?q=user" id="lock-button"><span id="lock-icon" class="login"></span><span>Login</span></a>
						<?php else : ?>
						<a href="<?php echo base_path(); ?>?q=logout" id="lock-button"><span id="lock-icon"></span><span>Logout</span></a>
						<?php endif; ?>
