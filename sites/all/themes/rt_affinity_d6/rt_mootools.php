...
<link href="<?php echo base_path() . path_to_theme(); ?>/js/rokbox/themes/affinity/rokbox-style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo base_path() . path_to_theme(); ?>/js/rokbox/rokbox.js"></script>
<script type="text/javascript" src="<?php echo base_path() . path_to_theme(); ?>/js/rokbox/themes/affinity/rokbox-config.js"></script>
...
<?php if($affinity_menu_type=="moomenu") :?>
