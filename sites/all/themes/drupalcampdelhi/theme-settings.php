...
/**
* USAGE:
* 1 - Change all instances of "drupalcampdelhi" to your themes name (there are only 2).
...
// Change 'drupalcampdelhi_settings' to 'your_themes_name_settings'
function drupalcampdelhi_settings($saved_settings) {

  // Change ('drupalcampdelhi') to ('your_themes_name')
  $defaults = adaptivetheme_theme_get_default_settings('drupalcampdelhi');
